<article class="markdown-body entry-content p-5" itemprop="text">
  <h1><a id="user-content--CarBooking" class="anchor" aria-hidden="true" href="#-CarBooking"><svg
        class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16"
        aria-hidden="true"></svg></a>
    <g-emoji class="g-emoji" alias="notebook"
      fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4d3.png">📓</g-emoji> CarBooking
  </h1>
  ...
  <p>CarBooking is a Desktop application for booking cars.</p>
  ...
  <p>CarBooking is a Desktop application build with JavaFX using files as a Database.</p>
    <p>See <a href="https://github.com/moustaphaOut/CarBooking">CarBooking</a> here</p>
  ...
  <h2><a id="user-content--screenshots" class="anchor" aria-hidden="true" href="#-screenshots"><svg
   ...
   <div class="Screenshots">
      <h3>welcome</h3>
      <img src="https://raw.githubusercontent.com/moustaphaOut/CarBooking/master/demoImages/welcome.JPG"
        alt="welcome">
    </div>
    <div class="Screenshots">
      <h3>choose Car</h3>
      <img src="https://raw.githubusercontent.com/moustaphaOut/CarBooking/master/demoImages/chooseCar.JPG"
        alt="chooseCar">
    </div>
    <div class="Screenshots">
      <h3>Car selected</h3>
      <img src="https://raw.githubusercontent.com/moustaphaOut/CarBooking/master/demoImages/carchoosed.JPG"
        alt="carchoosed">
    </div>
     <div class="Screenshots">
      <h3>Client Information</h3>
      <img src="https://raw.githubusercontent.com/moustaphaOut/CarBooking/master/demoImages/ReserveCar.JPG"
        alt="ReserveCar">
    </div>
     <div class="Screenshots">
      <h3>Thank You Page</h3>
      <img src="https://raw.githubusercontent.com/moustaphaOut/CarBooking/master/demoImages/ThankYouPage.JPG"
        alt="ThankYouPage">
    </div>
  ...
  <p>Under <a href="https://github.com/moustaphaOut/CarBooking/blob/master/LICENSE">MIT license</a> but don't forget to reference :).</p>
